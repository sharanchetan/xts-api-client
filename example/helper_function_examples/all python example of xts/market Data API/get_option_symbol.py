...
async def main():
    ...
    resp = await xt_market_data.get_option_symbol(exchangeSegment=2, series="OPTIDX", symbol="NIFTY", expiryDate="04Aug2026",optionType="CE", strikePrice=24250)
    print(resp)
    print(resp.get('result')[0].get('FreezeQty'))
