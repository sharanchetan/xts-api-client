...
async def main():
    ...
    resp = await xt_interactive_data.convert_position ( exchangeSegment=2,exchangeInstrumentID=12345, targetQty=25, isDayWise=True, oldProductType="MIS", newProductType="NRML" )
    print(resp)
